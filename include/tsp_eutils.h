...
extern void             CPLEX_mip_st(CPXENVptr, CPXLPptr, int*, const unsigned int);
//extern void             CPLEX_edit_mip_st(CPXENVptr*, CPXLPptr*, int*, const unsigned int);
...
extern void             add_warm_start(CPXENVptr, CPXLPptr, TSPinst*, TSPenv*);
